(function() {
  ...
  Handlebar = (function() {
    ...
    Handlebar.prototype._parseSection = function(tokens) {
      var i, id, indentation, key, nextNode, node, nodes, partialNode, previousNode, renderedNode, section, sectionEnded, startLine, string, token, _len;
      nodes = [];
      sectionEnded = false;
    ...
    Handlebar.prototype._closeSection = function(tokens, id) {
      ...
      if (nextString.length > 0 && id.toString() !== nextString) {
        throw new ParseException("Start section " + id + " doesn't match end " + advanceOverNextString, tokens.nextLine);
      }
