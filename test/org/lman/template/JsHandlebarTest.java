...
import org.lman.process.NodeProcess;

public class JsHandlebarTest extends AbstractHandlebarTest {
  ...
  protected String render(File json, File template, List<File> partialTemplates) throws Exception {
    ...
    NodeProcess node = new NodeProcess(new File("js"), "HandlebarTest.js");
    NodeProcess.Output output = node.run(args.toArray(new String[]{}));
